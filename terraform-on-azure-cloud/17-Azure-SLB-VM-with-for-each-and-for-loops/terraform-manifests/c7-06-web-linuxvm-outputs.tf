...
# Output List - Single Input to for loop -> list are with [] brackets
output "web_linuxvm_private_ip_address_lists" {
...
# Output Map - Single Input to for loop -> maps are with {} brackets
...
output "web_linuxvm_network_interaface_id_lists" {
...
output "web_linuxvm_network_interaface_id_map" {
  description = "Web Linux VM Network Interface ID"
