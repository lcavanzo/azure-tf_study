...
# Resource-3: Create LB Backed Pool
...
# Resource-6: Associate netwrok Interface and Standard Load Balancer
...
resource "azurerm_network_interface_backend_address_pool_association" "web_nic_lb_associate" {
  ...
  ip_configuration_name   = azurerm_network_interface.web_linuxvm_nic[count.index].ip_configuration[0].name // this aproach has the same result as the above line
