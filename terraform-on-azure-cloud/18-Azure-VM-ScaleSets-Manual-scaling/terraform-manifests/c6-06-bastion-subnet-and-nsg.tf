...
# Resource-2: Create Network Securty Group (NSG)
...
resource "azurerm_subnet_network_security_group_association" "bastion_subnet_associate" {
  depends_on = [
...
## Locals Blocck for Securty Rules
